define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'music/my_collections/index' + location.search,
                    add_url: 'music/my_collections/add',
                    edit_url: 'music/my_collections/edit',
                    del_url: 'music/my_collections/del',
                    multi_url: 'music/my_collections/multi',
                    table: 'music_my_collections',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'music/my_collections/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'music/my_collections/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'music/my_collections/destroy',
                                    refresh: true
                                }
                            ],
