define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'music/message/index' + location.search,
                    add_url: 'music/message/add',
                    edit_url: 'music/message/edit',
                    del_url: 'music/message/del',
                    multi_url: 'music/message/multi',
                    table: 'music_message',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'group_number', title: __('Group_number')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'music/message/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
