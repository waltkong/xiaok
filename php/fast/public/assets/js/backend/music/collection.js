define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'music/collection/index' + location.search,
                    add_url: 'music/collection/add',
                    edit_url: 'music/collection/edit',
                    del_url: 'music/collection/del',
                    multi_url: 'music/collection/multi',
                    table: 'music_collection',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'music/collection/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
